...
def get_prediction_error(perceptron:Perceptron, x_values:List[List[float]], y_values:List[float], error_function:ErrorFunctionType, beta:float=1.0, descale_fun = None)->float:
    errors = []
